...
// init width height
// create a zone of pixel using allocate
// all the rest is on the stack
// access from memory the pixels
...
export function init(width: i16, height: i16): void {
  let memory = allocate_memory(width * height * 3 * sizeof<u8>());
